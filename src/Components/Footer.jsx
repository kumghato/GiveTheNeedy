    ...
    <footer className=''>
      ...
      <div className='bg-[var(--secondaryColor)] px-10 py-10 text-gray-100'>
        <div className='text-center'>
          <h3 className='font-bold sm:text-[1.5rem] m-auto'>GiveTheNeedy is a platform to connect donors and recievers for impactful giving.</h3>
        </div>
        <div className='flex'>
          <div className='sm:w-[40%] '>
            ...
            <div className='my-5'>
              <FiPhoneCall className='text-sm sm:text-2xl' />
          ...
          <div className='m-auto'>
            ...
            <h4 className='font-bold text-center mt-20 text-sm'>Download the App!!</h4>
