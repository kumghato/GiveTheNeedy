        ...
        <>
            ...
            <div className='w-full'>
                ...
                <div className='w-[70%] absolute top-[15%] lg:top-[20%] ms-14 sm:ms-28'>
                    ...
                    <div className='text-[.6rem] sm:text-lg md:text-2xl tracking-widest mt-4 text-shadow lg:leading-9'>
                    ...
                    <button className='hover:bg-white hover:text-[var(--primaryColor)] hover:border hover:border-[var(--primaryColor)] bg-[#fc6a03] px-2 py-1 md:px-5 md:py-3 rounded-[2rem] text-white md:font-bold mt-3 md:mt-5 lg:mt-10 text-[0.6rem] sm:mt-10 text-sm sm:text-lg'>Join us today</button>
                </div>
            </div>
            <WhyUs />
            <Footer />
