    ...
    return (
        <>
            <div className='container flex mt-20 mb-10'>
                <div className='border my-3 flex m-auto w-[80%]'>
                    <div className='w-1/2'>
                    ...
                    <hr className='h-3/5 m-auto border border-gray-400' />
                    <div className='w-1/2'>
                        <div className='p-10 flex flex-col'>
                            ...
                            <div className='my-4'>
                                <div className='flex items-center w-2/4'>
                                    <FaPhoneAlt className='text-3xl me-4' />
                                    <p className='mb-0'>+91 986 269 4100</p>
                                </div>
                                <div className='flex items-center mt-5'>
                                    <FaRegEnvelope className='text-3xl me-4' />
